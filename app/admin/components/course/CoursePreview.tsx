...
import CoursePlayer from "@/utils/Sections/CoursePlayer";
import Ratings from "@/utils/Sections/Ratings";
    ...
    <div className="">
      <div className="w-full relative">
        <div className="w-full">
          {courseData?.demoUrl && courseData?.demoUrl !== "" && (
            <CoursePlayer
        ...
        <div className="flex items-center">
          ...
          <h4 className="pl-5 pt-4 text-[22px]">
            {discountPercentengePrice ? discountPercentengePrice : ""}% Off
          </h4>
        </div>
